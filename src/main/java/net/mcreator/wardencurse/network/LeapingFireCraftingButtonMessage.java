...
import net.mcreator.wardencurse.procedures.CraftLeapingFireProcedure;
...
public class LeapingFireCraftingButtonMessage {
	private final int buttonID, x, y, z;

	public LeapingFireCraftingButtonMessage(FriendlyByteBuf buffer) {
	...
	public LeapingFireCraftingButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(LeapingFireCraftingButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(LeapingFireCraftingButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = LeapingFireCraftingMenu.guistate;
		...
		if (buttonID == 13) {
			...
			CraftLeapingFireProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		WardenCurseMod.addNetworkMessage(LeapingFireCraftingButtonMessage.class, LeapingFireCraftingButtonMessage::buffer, LeapingFireCraftingButtonMessage::new, LeapingFireCraftingButtonMessage::handler);
	}
}
