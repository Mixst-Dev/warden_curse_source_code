...
import net.mcreator.wardencurse.procedures.CraftLazuliteAxeProcedure;
...
public class LazuliteAxeCraftingButtonMessage {
	private final int buttonID, x, y, z;

	public LazuliteAxeCraftingButtonMessage(FriendlyByteBuf buffer) {
	...
	public LazuliteAxeCraftingButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(LazuliteAxeCraftingButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(LazuliteAxeCraftingButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = LazuliteAxeCraftingMenu.guistate;
		...
		if (buttonID == 13) {
			...
			CraftLazuliteAxeProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		WardenCurseMod.addNetworkMessage(LazuliteAxeCraftingButtonMessage.class, LazuliteAxeCraftingButtonMessage::buffer, LazuliteAxeCraftingButtonMessage::new, LazuliteAxeCraftingButtonMessage::handler);
	}
}
