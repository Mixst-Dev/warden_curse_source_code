...
import net.mcreator.wardencurse.procedures.DashOnKeyPressedProcedure;
...
public class DashMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		WardenCurseMod.addNetworkMessage(DashMessage.class, DashMessage::buffer, DashMessage::new, DashMessage::handler);
	}
}
