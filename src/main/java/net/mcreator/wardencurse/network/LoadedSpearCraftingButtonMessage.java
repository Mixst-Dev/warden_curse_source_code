...
import net.mcreator.wardencurse.procedures.CraftLoadedSpearProcedure;
...
public class LoadedSpearCraftingButtonMessage {
	private final int buttonID, x, y, z;

	public LoadedSpearCraftingButtonMessage(FriendlyByteBuf buffer) {
	...
	public LoadedSpearCraftingButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(LoadedSpearCraftingButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(LoadedSpearCraftingButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = LoadedSpearCraftingMenu.guistate;
		...
		if (buttonID == 13) {
			...
			CraftLoadedSpearProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		WardenCurseMod.addNetworkMessage(LoadedSpearCraftingButtonMessage.class, LoadedSpearCraftingButtonMessage::buffer, LoadedSpearCraftingButtonMessage::new, LoadedSpearCraftingButtonMessage::handler);
	}
}
