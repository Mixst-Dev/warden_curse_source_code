...
import net.mcreator.wardencurse.procedures.CraftFlameVentProcedure;
...
public class FlameVentCraftGUIButtonMessage {
	private final int buttonID, x, y, z;

	public FlameVentCraftGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public FlameVentCraftGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(FlameVentCraftGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(FlameVentCraftGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = FlameVentCraftGUIMenu.guistate;
		...
		if (buttonID == 13) {
			...
			CraftFlameVentProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		WardenCurseMod.addNetworkMessage(FlameVentCraftGUIButtonMessage.class, FlameVentCraftGUIButtonMessage::buffer, FlameVentCraftGUIButtonMessage::new, FlameVentCraftGUIButtonMessage::handler);
	}
}
