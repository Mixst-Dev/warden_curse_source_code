...
public class ProstheticTableButtonMessage {
	private final int buttonID, x, y, z;

	public ProstheticTableButtonMessage(FriendlyByteBuf buffer) {
	...
	public ProstheticTableButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(ProstheticTableButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(ProstheticTableButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = ProstheticTableMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		WardenCurseMod.addNetworkMessage(ProstheticTableButtonMessage.class, ProstheticTableButtonMessage::buffer, ProstheticTableButtonMessage::new, ProstheticTableButtonMessage::handler);
	}
}
