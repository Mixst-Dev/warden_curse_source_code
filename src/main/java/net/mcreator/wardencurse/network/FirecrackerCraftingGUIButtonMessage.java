...
import net.mcreator.wardencurse.procedures.CraftFireCrackersProcedure;
...
public class FirecrackerCraftingGUIButtonMessage {
	private final int buttonID, x, y, z;

	public FirecrackerCraftingGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public FirecrackerCraftingGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(FirecrackerCraftingGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(FirecrackerCraftingGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = FirecrackerCraftingGUIMenu.guistate;
		...
		if (buttonID == 13) {
			...
			CraftFireCrackersProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		WardenCurseMod.addNetworkMessage(FirecrackerCraftingGUIButtonMessage.class, FirecrackerCraftingGUIButtonMessage::buffer, FirecrackerCraftingGUIButtonMessage::new, FirecrackerCraftingGUIButtonMessage::handler);
	}
}
