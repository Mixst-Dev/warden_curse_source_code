...
import net.mcreator.wardencurse.procedures.CraftPurpleFumeProcedure;
...
public class PurpleFumeCraftingGUIButtonMessage {
	private final int buttonID, x, y, z;

	public PurpleFumeCraftingGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public PurpleFumeCraftingGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(PurpleFumeCraftingGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(PurpleFumeCraftingGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = PurpleFumeCraftingGUIMenu.guistate;
		...
		if (buttonID == 13) {
			...
			CraftPurpleFumeProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		WardenCurseMod.addNetworkMessage(PurpleFumeCraftingGUIButtonMessage.class, PurpleFumeCraftingGUIButtonMessage::buffer, PurpleFumeCraftingGUIButtonMessage::new, PurpleFumeCraftingGUIButtonMessage::handler);
	}
}
