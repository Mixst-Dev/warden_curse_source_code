...
import net.mcreator.wardencurse.procedures.CraftLongsparkProcedure;
...
public class LongsparkCraftingGUIButtonMessage {
	private final int buttonID, x, y, z;

	public LongsparkCraftingGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public LongsparkCraftingGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(LongsparkCraftingGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(LongsparkCraftingGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = LongsparkCraftingGUIMenu.guistate;
		...
		if (buttonID == 13) {
			...
			CraftLongsparkProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		WardenCurseMod.addNetworkMessage(LongsparkCraftingGUIButtonMessage.class, LongsparkCraftingGUIButtonMessage::buffer, LongsparkCraftingGUIButtonMessage::new, LongsparkCraftingGUIButtonMessage::handler);
	}
}
