...
public class Modelonemind2<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("warden_curse", "modelonemind_2"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition trail1 = partdefinition.addOrReplaceChild("trail1", CubeListBuilder.create().texOffs(4, 6).addBox(-4.0F, -5.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = trail1.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 0).addBox(-32.0F, -0.5F, -32.0F, 64.0F, 0.0F, 64.0F, new CubeDeformation(0.0F)),
