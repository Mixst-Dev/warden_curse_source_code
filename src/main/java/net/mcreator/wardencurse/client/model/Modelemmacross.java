...
public class Modelemmacross<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("warden_curse", "modelemmacross"), "main");
	public final ModelPart head;

	public Modelemmacross(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r2 = slash2.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 0).addBox(-42.0F, -1.0F, -56.0F, 69.0F, 0.0F, 58.0F, new CubeDeformation(0.0F)),
