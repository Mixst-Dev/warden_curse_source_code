...
import net.mcreator.wardencurse.network.Dragonflashgui2ButtonMessage;
...
public class Dragonflashgui2Screen extends AbstractContainerScreen<Dragonflashgui2Menu> {
	private final static HashMap<String, Object> guistate = Dragonflashgui2Menu.guistate;
	...
	public Dragonflashgui2Screen(Dragonflashgui2Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("warden_curse:textures/screens/dragonflashgui_2.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("warden_curse:textures/screens/dragonflash.png"), this.leftPos + -173, this.topPos + -72, 0, 0, 44, 44, 44, 44);

		guiGraphics.blit(new ResourceLocation("warden_curse:textures/screens/bdragon.png"), this.leftPos + -105, this.topPos + -82, 0, 0, 270, 63, 270, 63);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.dragonflashgui_2.label_type_combat_art_shadow_rush"), -108, -103, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.dragonflashgui_2.label_se_cost"), -178, -22, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.dragonflashgui_2.label_dmg_multipler"), -178, -11, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.dragonflashgui_2.label_unleashes_a_powerfull_thrust"), -96, 5, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.dragonflashgui_2.label_impale_your_opponent"), -96, 16, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.dragonflashgui_2.label_description"), -96, -9, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.dragonflashgui_2.label_to_cut_your_opponent"), -95, 44, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.dragonflashgui_2.label_notes"), -178, 18, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.dragonflashgui_2.label_bestowal"), -178, 31, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.dragonflashgui_2.label_x075"), -178, 41, -12829636, false);
	}
	...
	public void init() {
		...
		imagebutton_but1 = new ImageButton(this.leftPos + -87, this.topPos + 93, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but1.png"), 18, 36, e -> {
			if (Lock1Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new Dragonflashgui2ButtonMessage(0, x, y, z));
				Dragonflashgui2ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}) {
			@Override
		...
		imagebutton_but2 = new ImageButton(this.leftPos + -51, this.topPos + 93, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but2.png"), 18, 36, e -> {
			if (Lock2Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new Dragonflashgui2ButtonMessage(1, x, y, z));
				Dragonflashgui2ButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but3 = new ImageButton(this.leftPos + -15, this.topPos + 93, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but3.png"), 18, 36, e -> {
			if (Lock3Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new Dragonflashgui2ButtonMessage(2, x, y, z));
				Dragonflashgui2ButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but4 = new ImageButton(this.leftPos + 21, this.topPos + 93, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but4.png"), 18, 36, e -> {
			if (Lock4Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new Dragonflashgui2ButtonMessage(3, x, y, z));
				Dragonflashgui2ButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but5 = new ImageButton(this.leftPos + 57, this.topPos + 93, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but5.png"), 18, 36, e -> {
			if (Lock5Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new Dragonflashgui2ButtonMessage(4, x, y, z));
				Dragonflashgui2ButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but6 = new ImageButton(this.leftPos + 93, this.topPos + 93, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but6.png"), 18, 36, e -> {
			if (Lock6Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new Dragonflashgui2ButtonMessage(5, x, y, z));
				Dragonflashgui2ButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but7 = new ImageButton(this.leftPos + 129, this.topPos + 93, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but7.png"), 18, 36, e -> {
			if (Lock7Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new Dragonflashgui2ButtonMessage(6, x, y, z));
				Dragonflashgui2ButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
