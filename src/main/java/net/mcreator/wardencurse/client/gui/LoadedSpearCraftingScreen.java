...
import net.mcreator.wardencurse.network.LoadedSpearCraftingButtonMessage;
...
public class LoadedSpearCraftingScreen extends AbstractContainerScreen<LoadedSpearCraftingMenu> {
	private final static HashMap<String, Object> guistate = LoadedSpearCraftingMenu.guistate;
	...
	public LoadedSpearCraftingScreen(LoadedSpearCraftingMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("warden_curse:textures/screens/loaded_spear_crafting.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("warden_curse:textures/screens/spear2gui.png"), this.leftPos + 115, this.topPos + -85, 0, 0, 60, 60, 60, 60);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.loaded_spear_crafting.label_prosthetic_table"), -45, -111, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.loaded_spear_crafting.label_prosthetic_loaded_axe"), 98, -14, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.loaded_spear_crafting.label_x5_iron_scraps"), 97, 11, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.loaded_spear_crafting.label_x2_wood_planks"), 97, 24, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.loaded_spear_crafting.label_x1_axe_of_monkey"), 97, -2, -12829636, false);
	}
	...
	public void init() {
		...
		imagebutton_p_tool = new ImageButton(this.leftPos + -194, this.topPos + -83, 34, 34, 0, 0, 34, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_p_tool.png"), 34, 68, e -> {
			if (true) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new LoadedSpearCraftingButtonMessage(0, x, y, z));
				LoadedSpearCraftingButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_p_tool1 = new ImageButton(this.leftPos + -135, this.topPos + -83, 34, 34, 0, 0, 34, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_p_tool1.png"), 34, 68, e -> {
			if (true) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new LoadedSpearCraftingButtonMessage(1, x, y, z));
				LoadedSpearCraftingButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_p_tool2 = new ImageButton(this.leftPos + -76, this.topPos + -83, 34, 34, 0, 0, 34, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_p_tool2.png"), 34, 68, e -> {
			if (true) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new LoadedSpearCraftingButtonMessage(2, x, y, z));
				LoadedSpearCraftingButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_p_tool3 = new ImageButton(this.leftPos + -194, this.topPos + -44, 34, 34, 0, 0, 34, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_p_tool3.png"), 34, 68, e -> {
			if (true) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new LoadedSpearCraftingButtonMessage(3, x, y, z));
				LoadedSpearCraftingButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		});
		...
		imagebutton_p_tool6 = new ImageButton(this.leftPos + -135, this.topPos + 34, 34, 34, 0, 0, 34, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_p_tool6.png"), 34, 68, e -> {
			if (true) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new LoadedSpearCraftingButtonMessage(6, x, y, z));
				LoadedSpearCraftingButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		});
		...
		imagebutton_p_tool7 = new ImageButton(this.leftPos + -76, this.topPos + 34, 34, 34, 0, 0, 34, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_p_tool7.png"), 34, 68, e -> {
			if (true) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new LoadedSpearCraftingButtonMessage(7, x, y, z));
				LoadedSpearCraftingButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		});
		...
		imagebutton_p_tool11 = new ImageButton(this.leftPos + -135, this.topPos + -5, 34, 34, 0, 0, 34, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_p_tool11.png"), 34, 68, e -> {
			if (true) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new LoadedSpearCraftingButtonMessage(11, x, y, z));
				LoadedSpearCraftingButtonMessage.handleButtonAction(entity, 11, x, y, z);
			}
		});
		...
		imagebutton_p_tool12 = new ImageButton(this.leftPos + -194, this.topPos + 34, 34, 34, 0, 0, 34, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_p_tool12.png"), 34, 68, e -> {
			if (true) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new LoadedSpearCraftingButtonMessage(12, x, y, z));
				LoadedSpearCraftingButtonMessage.handleButtonAction(entity, 12, x, y, z);
			}
		});
		...
		imagebutton_craft = new ImageButton(this.leftPos + 98, this.topPos + 79, 94, 29, 0, 0, 29, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_craft.png"), 94, 58, e -> {
			if (true) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new LoadedSpearCraftingButtonMessage(13, x, y, z));
				LoadedSpearCraftingButtonMessage.handleButtonAction(entity, 13, x, y, z);
			}
		});
