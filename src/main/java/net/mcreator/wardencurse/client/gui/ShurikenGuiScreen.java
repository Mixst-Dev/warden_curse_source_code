...
import net.mcreator.wardencurse.network.ShurikenGuiButtonMessage;
...
public class ShurikenGuiScreen extends AbstractContainerScreen<ShurikenGuiMenu> {
	private final static HashMap<String, Object> guistate = ShurikenGuiMenu.guistate;
	...
	public ShurikenGuiScreen(ShurikenGuiMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("warden_curse:textures/screens/shuriken_gui.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("warden_curse:textures/screens/shurikensgauge2.png"), this.leftPos + -141, this.topPos + -68, 0, 0, 60, 60, 60, 60);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.shuriken_gui.label_type_combat_art_shadow_rush"), -142, -94, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.shuriken_gui.label_se_cost"), -140, -3, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.shuriken_gui.label_dmg_multipler"), -140, 6, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.shuriken_gui.label_unleashes_a_powerfull_thrust"), -60, -54, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.shuriken_gui.label_impale_your_opponent"), -60, -44, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.shuriken_gui.label_description"), -60, -66, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.shuriken_gui.label_to_cut_your_opponent"), -60, -34, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.shuriken_gui.label_on_enemies_midair"), -60, -23, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.shuriken_gui.label_sneak_use_spinning_shuriken"), -60, -8, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.shuriken_gui.label_dmg_x06"), -60, 1, -12829636, false);
	}
	...
	public void init() {
		...
		imagebutton_but1 = new ImageButton(this.leftPos + -120, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but1.png"), 18, 36, e -> {
			if (Plock1Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new ShurikenGuiButtonMessage(0, x, y, z));
				ShurikenGuiButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}) {
			@Override
		...
		imagebutton_but2 = new ImageButton(this.leftPos + -84, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but2.png"), 18, 36, e -> {
			if (Plock2Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new ShurikenGuiButtonMessage(1, x, y, z));
				ShurikenGuiButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but3 = new ImageButton(this.leftPos + -48, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but3.png"), 18, 36, e -> {
			if (Plock3Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new ShurikenGuiButtonMessage(2, x, y, z));
				ShurikenGuiButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but4 = new ImageButton(this.leftPos + -12, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but4.png"), 18, 36, e -> {
			if (Plock4Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new ShurikenGuiButtonMessage(3, x, y, z));
				ShurikenGuiButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but5 = new ImageButton(this.leftPos + 24, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but5.png"), 18, 36, e -> {
			if (Plock5Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new ShurikenGuiButtonMessage(4, x, y, z));
				ShurikenGuiButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but6 = new ImageButton(this.leftPos + 60, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but6.png"), 18, 36, e -> {
			if (Plock6Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new ShurikenGuiButtonMessage(5, x, y, z));
				ShurikenGuiButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but7 = new ImageButton(this.leftPos + 96, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but7.png"), 18, 36, e -> {
			if (Plock7Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new ShurikenGuiButtonMessage(6, x, y, z));
				ShurikenGuiButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
