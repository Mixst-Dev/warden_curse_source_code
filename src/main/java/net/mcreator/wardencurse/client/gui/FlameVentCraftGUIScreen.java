...
import net.mcreator.wardencurse.network.FlameVentCraftGUIButtonMessage;
...
public class FlameVentCraftGUIScreen extends AbstractContainerScreen<FlameVentCraftGUIMenu> {
	private final static HashMap<String, Object> guistate = FlameVentCraftGUIMenu.guistate;
	...
	public FlameVentCraftGUIScreen(FlameVentCraftGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("warden_curse:textures/screens/flame_vent_craft_gui.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("warden_curse:textures/screens/firevent3gui.png"), this.leftPos + 115, this.topPos + -85, 0, 0, 60, 60, 60, 60);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.flame_vent_craft_gui.label_prosthetic_table"), -45, -111, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.flame_vent_craft_gui.label_prosthetic_loaded_axe"), 98, -14, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.flame_vent_craft_gui.label_x5_iron_scraps"), 97, -2, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.flame_vent_craft_gui.label_x2_wood_planks"), 96, 9, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.flame_vent_craft_gui.label_x16_black_gunpowder"), 97, 21, -12829636, false);
	}
	...
	public void init() {
		...
		imagebutton_p_tool = new ImageButton(this.leftPos + -194, this.topPos + -83, 34, 34, 0, 0, 34, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_p_tool.png"), 34, 68, e -> {
			if (true) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new FlameVentCraftGUIButtonMessage(0, x, y, z));
				FlameVentCraftGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_p_tool1 = new ImageButton(this.leftPos + -135, this.topPos + -83, 34, 34, 0, 0, 34, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_p_tool1.png"), 34, 68, e -> {
			if (true) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new FlameVentCraftGUIButtonMessage(1, x, y, z));
				FlameVentCraftGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_p_tool2 = new ImageButton(this.leftPos + -76, this.topPos + -83, 34, 34, 0, 0, 34, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_p_tool2.png"), 34, 68, e -> {
			if (true) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new FlameVentCraftGUIButtonMessage(2, x, y, z));
				FlameVentCraftGUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_p_tool6 = new ImageButton(this.leftPos + -135, this.topPos + 34, 34, 34, 0, 0, 34, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_p_tool6.png"), 34, 68, e -> {
			if (true) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new FlameVentCraftGUIButtonMessage(6, x, y, z));
				FlameVentCraftGUIButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		});
		...
		imagebutton_p_tool7 = new ImageButton(this.leftPos + -76, this.topPos + 34, 34, 34, 0, 0, 34, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_p_tool7.png"), 34, 68, e -> {
			if (true) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new FlameVentCraftGUIButtonMessage(7, x, y, z));
				FlameVentCraftGUIButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		});
		...
		imagebutton_p_tool10 = new ImageButton(this.leftPos + -194, this.topPos + -5, 34, 34, 0, 0, 34, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_p_tool10.png"), 34, 68, e -> {
			if (true) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new FlameVentCraftGUIButtonMessage(10, x, y, z));
				FlameVentCraftGUIButtonMessage.handleButtonAction(entity, 10, x, y, z);
			}
		});
		...
		imagebutton_p_tool11 = new ImageButton(this.leftPos + -135, this.topPos + -5, 34, 34, 0, 0, 34, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_p_tool11.png"), 34, 68, e -> {
			if (true) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new FlameVentCraftGUIButtonMessage(11, x, y, z));
				FlameVentCraftGUIButtonMessage.handleButtonAction(entity, 11, x, y, z);
			}
		});
		...
		imagebutton_p_tool12 = new ImageButton(this.leftPos + -194, this.topPos + 34, 34, 34, 0, 0, 34, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_p_tool12.png"), 34, 68, e -> {
			if (true) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new FlameVentCraftGUIButtonMessage(12, x, y, z));
				FlameVentCraftGUIButtonMessage.handleButtonAction(entity, 12, x, y, z);
			}
		});
		...
		imagebutton_craft = new ImageButton(this.leftPos + 98, this.topPos + 79, 94, 29, 0, 0, 29, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_craft.png"), 94, 58, e -> {
			if (true) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new FlameVentCraftGUIButtonMessage(13, x, y, z));
				FlameVentCraftGUIButtonMessage.handleButtonAction(entity, 13, x, y, z);
			}
		});
