...
import net.mcreator.wardencurse.network.LazuliteVentGUIButtonMessage;
...
public class LazuliteVentGUIScreen extends AbstractContainerScreen<LazuliteVentGUIMenu> {
	private final static HashMap<String, Object> guistate = LazuliteVentGUIMenu.guistate;
	...
	public LazuliteVentGUIScreen(LazuliteVentGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("warden_curse:textures/screens/lazulite_vent_gui.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("warden_curse:textures/screens/lazulitevent2.png"), this.leftPos + -141, this.topPos + -68, 0, 0, 60, 60, 60, 60);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazulite_vent_gui.label_type_combat_art_shadow_rush"), -142, -94, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazulite_vent_gui.label_se_cost"), -139, -3, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazulite_vent_gui.label_dmg_multipler"), -140, 6, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazulite_vent_gui.label_unleashes_a_powerfull_thrust"), -60, -54, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazulite_vent_gui.label_description"), -60, -66, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazulite_vent_gui.label_short_range"), -60, -44, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazulite_vent_gui.label_this_tool_also_sets_burning_stat"), -60, -33, -12829636, false);
	}
	...
	public void init() {
		...
		imagebutton_but1 = new ImageButton(this.leftPos + -120, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but1.png"), 18, 36, e -> {
			if (Plock1Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new LazuliteVentGUIButtonMessage(0, x, y, z));
				LazuliteVentGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}) {
			@Override
		...
		imagebutton_but2 = new ImageButton(this.leftPos + -84, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but2.png"), 18, 36, e -> {
			if (Plock2Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new LazuliteVentGUIButtonMessage(1, x, y, z));
				LazuliteVentGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but3 = new ImageButton(this.leftPos + -48, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but3.png"), 18, 36, e -> {
			if (Plock3Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new LazuliteVentGUIButtonMessage(2, x, y, z));
				LazuliteVentGUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but4 = new ImageButton(this.leftPos + -12, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but4.png"), 18, 36, e -> {
			if (Plock4Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new LazuliteVentGUIButtonMessage(3, x, y, z));
				LazuliteVentGUIButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but5 = new ImageButton(this.leftPos + 24, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but5.png"), 18, 36, e -> {
			if (Plock5Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new LazuliteVentGUIButtonMessage(4, x, y, z));
				LazuliteVentGUIButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but6 = new ImageButton(this.leftPos + 60, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but6.png"), 18, 36, e -> {
			if (Plock6Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new LazuliteVentGUIButtonMessage(5, x, y, z));
				LazuliteVentGUIButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but7 = new ImageButton(this.leftPos + 96, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but7.png"), 18, 36, e -> {
			if (Plock7Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new LazuliteVentGUIButtonMessage(6, x, y, z));
				LazuliteVentGUIButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
