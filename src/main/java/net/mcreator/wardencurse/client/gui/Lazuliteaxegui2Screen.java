...
public class Lazuliteaxegui2Screen extends AbstractContainerScreen<Lazuliteaxegui2Menu> {
	private final static HashMap<String, Object> guistate = Lazuliteaxegui2Menu.guistate;
	...
	public Lazuliteaxegui2Screen(Lazuliteaxegui2Menu container, Inventory inventory, Component text) {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("warden_curse:textures/screens/lazuliteaxe2.png"), this.leftPos + -141, this.topPos + -68, 0, 0, 60, 60, 60, 60);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazuliteaxegui_2.label_type_combat_art_shadow_rush"), -142, -94, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazuliteaxegui_2.label_se_cost"), -140, -3, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazuliteaxegui_2.label_dmg_multipler"), -140, 6, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazuliteaxegui_2.label_unleashes_a_powerfull_thrust"), -60, -54, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazuliteaxegui_2.label_impale_your_opponent"), -60, -44, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazuliteaxegui_2.label_description"), -60, -66, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazuliteaxegui_2.label_to_cut_your_opponent"), -60, -34, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazuliteaxegui_2.label_shift_attack_slam_down_attac"), -59, -20, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazuliteaxegui_2.label_pk_prosthetic_keybind"), -142, -116, -52429, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazuliteaxegui_2.label_swipe_x19_damage"), -59, -12, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazuliteaxegui_2.label_additional_information"), -59, 0, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.warden_curse.lazuliteaxegui_2.label_posture_damage_multiplyer_x3"), -59, 10, -12829636, false);
	}
	...
	public void init() {
		...
		imagebutton_but1 = new ImageButton(this.leftPos + -120, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but1.png"), 18, 36, e -> {
			if (Plock1Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new Lazuliteaxegui2ButtonMessage(0, x, y, z));
				Lazuliteaxegui2ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}) {
			@Override
		...
		imagebutton_but2 = new ImageButton(this.leftPos + -84, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but2.png"), 18, 36, e -> {
			if (Plock2Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new Lazuliteaxegui2ButtonMessage(1, x, y, z));
				Lazuliteaxegui2ButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but3 = new ImageButton(this.leftPos + -48, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but3.png"), 18, 36, e -> {
			if (Plock3Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new Lazuliteaxegui2ButtonMessage(2, x, y, z));
				Lazuliteaxegui2ButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but4 = new ImageButton(this.leftPos + -12, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but4.png"), 18, 36, e -> {
			if (Plock4Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new Lazuliteaxegui2ButtonMessage(3, x, y, z));
				Lazuliteaxegui2ButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but5 = new ImageButton(this.leftPos + 24, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but5.png"), 18, 36, e -> {
			if (Plock5Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new Lazuliteaxegui2ButtonMessage(4, x, y, z));
				Lazuliteaxegui2ButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but6 = new ImageButton(this.leftPos + 60, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but6.png"), 18, 36, e -> {
			if (Plock6Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new Lazuliteaxegui2ButtonMessage(5, x, y, z));
				Lazuliteaxegui2ButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_but7 = new ImageButton(this.leftPos + 96, this.topPos + 45, 18, 18, 0, 0, 18, new ResourceLocation("warden_curse:textures/screens/atlas/imagebutton_but7.png"), 18, 36, e -> {
			if (Plock7Procedure.execute(entity)) {
				WardenCurseMod.PACKET_HANDLER.sendToServer(new Lazuliteaxegui2ButtonMessage(6, x, y, z));
				Lazuliteaxegui2ButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		}) {
			@Override
			public void render(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
