...
import net.mcreator.wardencurse.item.model.SekrioGearCustomModel;
import net.mcreator.wardencurse.item.SekrioGearCustomItem;

public class SekrioGearCustomArmorRenderer extends GeoArmorRenderer<SekrioGearCustomItem> {
	public SekrioGearCustomArmorRenderer() {
		super(new SekrioGearCustomModel());
	...
	@Override
	public RenderType getRenderType(SekrioGearCustomItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
