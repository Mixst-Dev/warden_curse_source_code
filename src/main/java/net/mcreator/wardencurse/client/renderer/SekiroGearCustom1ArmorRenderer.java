...
import net.mcreator.wardencurse.item.model.SekiroGearCustom1Model;
import net.mcreator.wardencurse.item.SekiroGearCustom1Item;

public class SekiroGearCustom1ArmorRenderer extends GeoArmorRenderer<SekiroGearCustom1Item> {
	public SekiroGearCustom1ArmorRenderer() {
		super(new SekiroGearCustom1Model());
	...
	@Override
	public RenderType getRenderType(SekiroGearCustom1Item animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
