...
import net.mcreator.wardencurse.item.model.SekiroGearCustom2Model;
import net.mcreator.wardencurse.item.SekiroGearCustom2Item;

public class SekiroGearCustom2ArmorRenderer extends GeoArmorRenderer<SekiroGearCustom2Item> {
	public SekiroGearCustom2ArmorRenderer() {
		super(new SekiroGearCustom2Model());
	...
	@Override
	public RenderType getRenderType(SekiroGearCustom2Item animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
