...
import net.mcreator.wardencurse.item.model.SekiroGearCustom3Model;
import net.mcreator.wardencurse.item.SekiroGearCustom3Item;

public class SekiroGearCustom3ArmorRenderer extends GeoArmorRenderer<SekiroGearCustom3Item> {
	public SekiroGearCustom3ArmorRenderer() {
		super(new SekiroGearCustom3Model());
	...
	@Override
	public RenderType getRenderType(SekiroGearCustom3Item animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
