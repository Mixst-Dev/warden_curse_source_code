...
import net.mcreator.wardencurse.item.model.ShuraHeadModel;
import net.mcreator.wardencurse.item.ShuraHeadItem;

public class ShuraHeadArmorRenderer extends GeoArmorRenderer<ShuraHeadItem> {
	public ShuraHeadArmorRenderer() {
		super(new ShuraHeadModel());
	...
	@Override
	public RenderType getRenderType(ShuraHeadItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
