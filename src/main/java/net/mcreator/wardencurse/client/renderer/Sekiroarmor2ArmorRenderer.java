...
import net.mcreator.wardencurse.item.model.Sekiroarmor2Model;
import net.mcreator.wardencurse.item.Sekiroarmor2Item;

public class Sekiroarmor2ArmorRenderer extends GeoArmorRenderer<Sekiroarmor2Item> {
	public Sekiroarmor2ArmorRenderer() {
		super(new Sekiroarmor2Model());
	...
	@Override
	public RenderType getRenderType(Sekiroarmor2Item animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
