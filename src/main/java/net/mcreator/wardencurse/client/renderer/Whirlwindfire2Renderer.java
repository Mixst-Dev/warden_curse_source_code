...
public class Whirlwindfire2Renderer extends MobRenderer<Whirlwindfire2Entity, Modelwhirlwind_2<Whirlwindfire2Entity>> {
	public Whirlwindfire2Renderer(EntityRendererProvider.Context context) {
		super(context, new Modelwhirlwind_2(context.bakeLayer(Modelwhirlwind_2.LAYER_LOCATION)), 0f);
		this.addLayer(new RenderLayer<Whirlwindfire2Entity, Modelwhirlwind_2<Whirlwindfire2Entity>>(this) {
			final ResourceLocation LAYER_TEXTURE = new ResourceLocation("warden_curse:textures/entities/whirl_fire_1.png");

			@Override
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, Whirlwindfire2Entity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	@Override
	protected void scale(Whirlwindfire2Entity entity, PoseStack poseStack, float f) {
		poseStack.scale(1.02f, 1.02f, 1.02f);
	}

	@Override
	public ResourceLocation getTextureLocation(Whirlwindfire2Entity entity) {
