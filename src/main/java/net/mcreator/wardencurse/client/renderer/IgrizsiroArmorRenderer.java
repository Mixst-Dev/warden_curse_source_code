...
import net.mcreator.wardencurse.item.model.IgrizsiroModel;
import net.mcreator.wardencurse.item.IgrizsiroItem;

public class IgrizsiroArmorRenderer extends GeoArmorRenderer<IgrizsiroItem> {
	public IgrizsiroArmorRenderer() {
		super(new IgrizsiroModel());
	...
	@Override
	public RenderType getRenderType(IgrizsiroItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
