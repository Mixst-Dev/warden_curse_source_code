...
import net.mcreator.wardencurse.item.model.ShuraModel;
import net.mcreator.wardencurse.item.ShuraItem;

public class ShuraArmorRenderer extends GeoArmorRenderer<ShuraItem> {
	public ShuraArmorRenderer() {
		super(new ShuraModel());
	...
	@Override
	public RenderType getRenderType(ShuraItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
