...
public class LazuliteShurikenRenderer extends EntityRenderer<LazuliteShurikenEntity> {
	...
	public LazuliteShurikenRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelfireworkshuriken(context.bakeLayer(Modelfireworkshuriken.LAYER_LOCATION));
	}

	@Override
	public void render(LazuliteShurikenEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(LazuliteShurikenEntity entity) {
		return texture;
	}
}
