...
import net.mcreator.wardencurse.item.model.SekiroarmorModel;
import net.mcreator.wardencurse.item.SekiroarmorItem;

public class SekiroarmorArmorRenderer extends GeoArmorRenderer<SekiroarmorItem> {
	public SekiroarmorArmorRenderer() {
		super(new SekiroarmorModel());
	...
	@Override
	public RenderType getRenderType(SekiroarmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
