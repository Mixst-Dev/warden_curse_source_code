...
import net.mcreator.wardencurse.item.model.SekiroCustomGear4Model;
import net.mcreator.wardencurse.item.SekiroCustomGear4Item;

public class SekiroCustomGear4ArmorRenderer extends GeoArmorRenderer<SekiroCustomGear4Item> {
	public SekiroCustomGear4ArmorRenderer() {
		super(new SekiroCustomGear4Model());
	...
	@Override
	public RenderType getRenderType(SekiroCustomGear4Item animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
