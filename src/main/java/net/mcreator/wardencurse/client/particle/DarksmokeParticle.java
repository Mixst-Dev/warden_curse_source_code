...
public class DarksmokeParticle extends TextureSheetParticle {
	public static DarksmokeParticleProvider provider(SpriteSet spriteSet) {
		return new DarksmokeParticleProvider(spriteSet);
	}
	...
	public static class DarksmokeParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			DarksmokeParticle particle = new DarksmokeParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
