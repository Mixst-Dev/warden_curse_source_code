...
import net.mcreator.wardencurse.procedures.BulletWhileProjectileFlyingTickProcedure;
import net.mcreator.wardencurse.procedures.BulletProjectileHitsLivingEntityProcedure;
...
public class BulletEntity extends AbstractArrow implements ItemSupplier {
	...
	public BulletEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(WardenCurseModEntities.BULLET.get(), world);
	}
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		BulletProjectileHitsLivingEntityProcedure.execute(this.level(), entityHitResult.getEntity(), this.getOwner());
	}

	@Override
	public void tick() {
		super.tick();
		BulletWhileProjectileFlyingTickProcedure.execute(this);
		if (this.inGround)
			this.discard();
	}
	...
	public static BulletEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		BulletEntity entityarrow = new BulletEntity(WardenCurseModEntities.BULLET.get(), entity, world);
	...
	public static BulletEntity shoot(LivingEntity entity, LivingEntity target) {
		BulletEntity entityarrow = new BulletEntity(WardenCurseModEntities.BULLET.get(), entity, entity.level());
