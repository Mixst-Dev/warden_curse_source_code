...
import net.mcreator.wardencurse.item.inventory.ShinobifirecrackerInventoryCapability;

import javax.annotation.Nullable;

import io.netty.buffer.Unpooled;

public class ShinobifirecrackerItem extends Item {
	public ShinobifirecrackerItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("§6Shinobi §6Firecracker");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new FirecrackerGUIMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new ShinobifirecrackerInventoryCapability();
	}
