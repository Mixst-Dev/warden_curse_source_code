...
import net.mcreator.wardencurse.procedures.YasharikuRightClickedProcedure;

import java.util.List;

public class YasharikuSugarItem extends Item {
	public YasharikuSugarItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		YasharikuRightClickedProcedure.execute(world, entity);
		return ar;
	}
}
