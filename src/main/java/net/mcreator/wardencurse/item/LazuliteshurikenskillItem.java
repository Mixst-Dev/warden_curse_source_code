...
import net.mcreator.wardencurse.item.inventory.LazuliteshurikenskillInventoryCapability;

import javax.annotation.Nullable;

import io.netty.buffer.Unpooled;

public class LazuliteshurikenskillItem extends Item {
	public LazuliteshurikenskillItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Lazulite Shuriken");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new LazuliteshurikenguiMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new LazuliteshurikenskillInventoryCapability();
	}
