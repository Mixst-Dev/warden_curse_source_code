...
import net.mcreator.wardencurse.procedures.ShootProcedure;
import net.mcreator.wardencurse.item.inventory.ProstheticGlockInventoryCapability;

import javax.annotation.Nullable;

import io.netty.buffer.Unpooled;

public class ProstheticGlockItem extends Item {
	public ProstheticGlockItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Prosthetic Glock");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new GlockGUIMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
		...
		ShootProcedure.execute(entity);
		return retval;
	}

	@Override
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new ProstheticGlockInventoryCapability();
	}
