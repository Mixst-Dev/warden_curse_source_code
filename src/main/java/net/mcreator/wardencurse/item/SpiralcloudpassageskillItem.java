...
import net.mcreator.wardencurse.item.inventory.SpiralcloudpassageskillInventoryCapability;

import javax.annotation.Nullable;

import io.netty.buffer.Unpooled;

public class SpiralcloudpassageskillItem extends Item {
	public SpiralcloudpassageskillItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Spiral Cloud Passage");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new Spiralcoudpassagegui2Menu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new SpiralcloudpassageskillInventoryCapability();
	}
