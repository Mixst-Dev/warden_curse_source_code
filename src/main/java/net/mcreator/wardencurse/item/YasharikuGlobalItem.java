...
import net.mcreator.wardencurse.procedures.GlobalYasharikuProcedure;

import java.util.List;

public class YasharikuGlobalItem extends Item {
	public YasharikuGlobalItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		GlobalYasharikuProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity);
		return ar;
	}
}
