...
import net.mcreator.wardencurse.item.inventory.FloatingPassageInventoryCapability;

import javax.annotation.Nullable;

import io.netty.buffer.Unpooled;

public class FloatingPassageItem extends Item {
	public FloatingPassageItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Floating Passage");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new FloatingPassageGUIMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new FloatingPassageInventoryCapability();
	}
