...
public class LazuliteAxeTriggerProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (entity.getPersistentData().getBoolean("L_Axe_Slam") == true) {
			entity.getPersistentData().putDouble("L_Axe_Slam_Timer", (entity.getPersistentData().getDouble("L_Axe_Slam_Timer") + 1));
			if (entity.getPersistentData().getDouble("L_Axe_Slam_Timer") == 1) {
				{
			...
			if (entity.getPersistentData().getDouble("L_Axe_Slam_Timer") == 5) {
			...
			if (entity.getPersistentData().getDouble("L_Axe_Slam_Timer") == 16) {
				if ((entity.getCapability(WardenCurseModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new WardenCurseModVariables.PlayerVariables())).Cancel_Prosthetic_Toggle == true) {
			...
			if (entity.getPersistentData().getDouble("L_Axe_Slam_Timer") == 18) {
				if ((entity.getCapability(WardenCurseModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new WardenCurseModVariables.PlayerVariables())).Cancel_Prosthetic_Toggle == true) {
					LazuliteAxeSlamProcedure.execute(world, entity);
					if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
						_entity.addEffect(new MobEffectInstance(WardenCurseModMobEffects.FREEZEMOVE.get(), 5, 3, false, false));
			...
			if (entity.getPersistentData().getDouble("L_Axe_Slam_Timer") == 33) {
				if ((entity.getCapability(WardenCurseModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new WardenCurseModVariables.PlayerVariables())).Cancel_Prosthetic_Toggle == true) {
					...
					entity.getPersistentData().putDouble("L_Axe_Slam_Timer", 0);
				}
			}
		} else {
			entity.getPersistentData().putDouble("L_Axe_Slam_Timer", (-1));
		}
	}
}
