...
public class Sakura2procProcedure {
	public static void execute(LevelAccessor world, double y, Entity entity) {
		...
		if (!(entity instanceof LivingEntity _livEnt14 && _livEnt14.hasEffect(WardenCurseModMobEffects.FIRESTATE.get())) && !(entity instanceof LivingEntity _livEnt15 && _livEnt15.hasEffect(WardenCurseModMobEffects.BLUEFIRESTATE.get()))
				&& !(entity instanceof LivingEntity _livEnt16 && _livEnt16.hasEffect(WardenCurseModMobEffects.CURSEDFIRESTATE.get()))) {
			{
				Entity _ent = entity;
				if (!_ent.level().isClientSide() && _ent.getServer() != null) {
					_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
							_ent.getName().getString(), _ent.getDisplayName(), _ent.level().getServer(), _ent), ("summon warden_curse:sakura_2 " + x2 + " ~-0.5 " + z2 + " {Rotation:[" + myyaw + "f," + 0 + "f]}"));
				}
			}
		}
		if (entity instanceof LivingEntity _livEnt18 && _livEnt18.hasEffect(WardenCurseModMobEffects.FIRESTATE.get())) {
			{
				Entity _ent = entity;
				if (!_ent.level().isClientSide() && _ent.getServer() != null) {
					_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
							_ent.getName().getString(), _ent.getDisplayName(), _ent.level().getServer(), _ent), ("summon warden_curse:nsakurafire_2 " + x2 + " ~0.5 " + z2 + " {Rotation:[" + myyaw + "f," + 0 + "f]}"));
				}
			}
		}
		if (entity instanceof LivingEntity _livEnt20 && _livEnt20.hasEffect(WardenCurseModMobEffects.BLUEFIRESTATE.get())) {
			{
				Entity _ent = entity;
				if (!_ent.level().isClientSide() && _ent.getServer() != null) {
					_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
							_ent.getName().getString(), _ent.getDisplayName(), _ent.level().getServer(), _ent), ("summon warden_curse:nsakuralazulite_2 " + x2 + " ~0.5 " + z2 + " {Rotation:[" + myyaw + "f," + 0 + "f]}"));
				}
			}
		}
		if (entity instanceof LivingEntity _livEnt22 && _livEnt22.hasEffect(WardenCurseModMobEffects.CURSEDFIRESTATE.get())) {
			{
				Entity _ent = entity;
				if (!_ent.level().isClientSide() && _ent.getServer() != null) {
					_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
							_ent.getName().getString(), _ent.getDisplayName(), _ent.level().getServer(), _ent), ("summon warden_curse:nsakuracurse_2 " + x2 + " ~0.5 " + z2 + " {Rotation:[" + myyaw + "f," + 0 + "f]}"));
				}
			}
		}
		for (int index0 = 0; index0 < 11; index0++) {
			...
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = WardenCurseModEntities.SAKURAVISUAL.get().spawn(_level, BlockPos.containing(xcord + ((Math.cos(yaw) * Math.cos(pitch)) / magnitude + 2 * Math.sin(yaw) * (-1) + 2.6 * Math.cos(yaw)) * 1, (y + height) - 1.3,
			...
			{
				final Vec3 _center = new Vec3((xcord + ((Math.cos(yaw) * Math.cos(pitch)) / magnitude + 2 * Math.sin(yaw) * (-1) + 2.6 * Math.cos(yaw)) * 1), ((y + height) - 1.3),
				...
				for (Entity entityiterator : _entfound) {
					if (!(entity == entityiterator) && !(entityiterator instanceof TamableAnimal _tamIsTamedBy && entity instanceof LivingEntity _livEnt ? _tamIsTamedBy.isOwnedBy(_livEnt) : false) && !(entityiterator instanceof ItemEntity)
						...
						if (!(entityiterator instanceof Player _plr ? _plr.getAbilities().instabuild : false)) {
							...
							if (entity instanceof LivingEntity _livEnt42 && _livEnt42.hasEffect(WardenCurseModMobEffects.FIRESTATE.get())) {
								entityiterator.setSecondsOnFire(5);
							}
						}
						if (entityiterator instanceof LivingEntity _livEnt44 && _livEnt44.hasEffect(WardenCurseModMobEffects.PARRY.get())) {
							if (entityiterator instanceof LivingEntity _entity && !_entity.level().isClientSide())
								_entity.addEffect(new MobEffectInstance(WardenCurseModMobEffects.PARRYVISUAL.get(), 10, 1, false, false));
						}
						if (!(entityiterator instanceof LivingEntity _livEnt46 && _livEnt46.hasEffect(WardenCurseModMobEffects.PARRY.get()))
						...
						entityiterator.setDeltaMovement(new Vec3((entity.getDeltaMovement().x() + entity.getLookAngle().x * 0.8), 0.2, (entity.getDeltaMovement().z() + entity.getLookAngle().z * 0.8)));
					}
				}
			}
