...
public class AshinaSoldierAtk1Procedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		entity.getPersistentData().putDouble("atk1_timer", (entity.getPersistentData().getDouble("atk1_timer") + 1));
		if (entity.getPersistentData().getDouble("atk1_timer") == 13) {
