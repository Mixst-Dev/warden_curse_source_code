...
public class Sakuratest1EntitySwingsItemProcedure {
	public static void execute(LevelAccessor world, double y, Entity entity) {
		...
		x2 = entity.getX() + entity.getLookAngle().x * 2.4;
		z2 = entity.getZ() + entity.getLookAngle().z * 2.4;
		...
		}
		{
			...
			if (!_ent.level().isClientSide() && _ent.getServer() != null) {
				_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
						_ent.getName().getString(), _ent.getDisplayName(), _ent.level().getServer(), _ent), "/photon fx photon:sakuraleap entity @s 0 0 0");
			}
		}
		if (entity.onGround()) {
		...
		if (!(entity instanceof LivingEntity _livEnt17 && _livEnt17.hasEffect(WardenCurseModMobEffects.FIRESTATE.get())) && !(entity instanceof LivingEntity _livEnt18 && _livEnt18.hasEffect(WardenCurseModMobEffects.BLUEFIRESTATE.get()))
				&& !(entity instanceof LivingEntity _livEnt19 && _livEnt19.hasEffect(WardenCurseModMobEffects.CURSEDFIRESTATE.get()))) {
			{
				Entity _ent = entity;
				if (!_ent.level().isClientSide() && _ent.getServer() != null) {
					_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
							_ent.getName().getString(), _ent.getDisplayName(), _ent.level().getServer(), _ent), ("summon warden_curse:sakura_1 " + x2 + " ~1.4 " + z2 + " {Rotation:[" + myyaw + "f," + 0 + "f]}"));
				}
			}
		}
		if (entity instanceof LivingEntity _livEnt21 && _livEnt21.hasEffect(WardenCurseModMobEffects.FIRESTATE.get())) {
			{
				Entity _ent = entity;
				if (!_ent.level().isClientSide() && _ent.getServer() != null) {
					_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
							_ent.getName().getString(), _ent.getDisplayName(), _ent.level().getServer(), _ent), ("summon warden_curse:nsakurafire_1 " + x2 + " ~0.5 " + z2 + " {Rotation:[" + myyaw + "f," + 0 + "f]}"));
				}
			}
		}
		if (entity instanceof LivingEntity _livEnt23 && _livEnt23.hasEffect(WardenCurseModMobEffects.BLUEFIRESTATE.get())) {
			{
				Entity _ent = entity;
				if (!_ent.level().isClientSide() && _ent.getServer() != null) {
					_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
							_ent.getName().getString(), _ent.getDisplayName(), _ent.level().getServer(), _ent), ("summon warden_curse:nsakuralazulite_1 " + x2 + " ~0.5 " + z2 + " {Rotation:[" + myyaw + "f," + 0 + "f]}"));
				}
			}
		}
		if (entity instanceof LivingEntity _livEnt25 && _livEnt25.hasEffect(WardenCurseModMobEffects.CURSEDFIRESTATE.get())) {
			{
				Entity _ent = entity;
				if (!_ent.level().isClientSide() && _ent.getServer() != null) {
					_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
							_ent.getName().getString(), _ent.getDisplayName(), _ent.level().getServer(), _ent), ("summon warden_curse:nsakuracurse_1 " + x2 + " ~0.5 " + z2 + " {Rotation:[" + myyaw + "f," + 0 + "f]}"));
				}
			}
		}
		for (int index0 = 0; index0 < 11; index0++) {
			yaw = ((entity.getYRot() + rotation) - 30) * (Math.PI / 180);
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = WardenCurseModEntities.SAKURAVISUAL.get().spawn(_level, BlockPos.containing(xcord + ((Math.cos(yaw) * Math.cos(pitch)) / magnitude + 2 * Math.sin(yaw) * (-1) + 2.6 * Math.cos(yaw)) * 1, y + height,
						zcord + ((Math.sin(yaw) * Math.cos(pitch)) / magnitude + 2 * Math.cos(yaw) + 2.6 * Math.sin(yaw)) * 1), MobSpawnType.MOB_SUMMONED);
				if (entityToSpawn != null) {
					entityToSpawn.setDeltaMovement(0, 0, 0);
				}
			}
			{
				final Vec3 _center = new Vec3((xcord + ((Math.cos(yaw) * Math.cos(pitch)) / magnitude + 2 * Math.sin(yaw) * (-1) + 2.6 * Math.cos(yaw)) * 1), (y + height),
						(zcord + ((Math.sin(yaw) * Math.cos(pitch)) / magnitude + 2 * Math.cos(yaw) + 2.6 * Math.sin(yaw)) * 1));
				...
				for (Entity entityiterator : _entfound) {
					if (!(entity == entityiterator) && !(entityiterator instanceof TamableAnimal _tamIsTamedBy && entity instanceof LivingEntity _livEnt ? _tamIsTamedBy.isOwnedBy(_livEnt) : false) && !(entityiterator instanceof ItemEntity)
						...
						if (!(entityiterator instanceof Player _plr ? _plr.getAbilities().instabuild : false)) {
							...
							if (entity instanceof LivingEntity _livEnt45 && _livEnt45.hasEffect(WardenCurseModMobEffects.FIRESTATE.get())) {
								entityiterator.setSecondsOnFire(2);
							}
						}
						if (entityiterator instanceof LivingEntity _livEnt47 && _livEnt47.hasEffect(WardenCurseModMobEffects.PARRY.get())) {
							if (entityiterator instanceof LivingEntity _entity && !_entity.level().isClientSide())
								_entity.addEffect(new MobEffectInstance(WardenCurseModMobEffects.PARRYVISUAL.get(), 10, 1, false, false));
						}
						if (!(entityiterator instanceof LivingEntity _livEnt49 && _livEnt49.hasEffect(WardenCurseModMobEffects.PARRY.get()))
		...
		WardenCurseMod.queueServerWork(3, () -> {
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(MobEffects.SLOW_FALLING, 18, 1, false, false));
		});
