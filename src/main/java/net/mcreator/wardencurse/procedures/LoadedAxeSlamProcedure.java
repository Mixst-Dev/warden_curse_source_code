...
public class LoadedAxeSlamProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (entity.getPersistentData().getBoolean("G_Axe_Slam") == true) {
			entity.getPersistentData().putDouble("M_Axe_Slam_Timer", (entity.getPersistentData().getDouble("M_Axe_Slam_Timer") + 1));
			if (entity.getPersistentData().getDouble("M_Axe_Slam_Timer") == 1) {
				{
			...
			if (entity.getPersistentData().getDouble("M_Axe_Slam_Timer") == 5) {
				if ((entity.getCapability(WardenCurseModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new WardenCurseModVariables.PlayerVariables())).Cancel_Prosthetic_Toggle == true) {
					{
						...
						if (!_ent.level().isClientSide() && _ent.getServer() != null) {
							_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
									_ent.getName().getString(), _ent.getDisplayName(), _ent.level().getServer(), _ent), "/playsound warden_curse:generic_draw player @a ~ ~ ~ 0.7");
						}
					}
					...
					if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == Blocks.AIR.asItem()) {
						if (entity instanceof LivingEntity _entity) {
							ItemStack _setstack = new ItemStack(WardenCurseModItems.LOADED_AXE.get()).copy();
			...
			if (entity.getPersistentData().getDouble("M_Axe_Slam_Timer") == 16) {
				if ((entity.getCapability(WardenCurseModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new WardenCurseModVariables.PlayerVariables())).Cancel_Prosthetic_Toggle == true) {
			...
			if (entity.getPersistentData().getDouble("M_Axe_Slam_Timer") == 19) {
				if ((entity.getCapability(WardenCurseModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new WardenCurseModVariables.PlayerVariables())).Cancel_Prosthetic_Toggle == true) {
					AxeSlamDmgProcedure.execute(world, entity);
					if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
			...
			if (entity.getPersistentData().getDouble("M_Axe_Slam_Timer") == 33) {
				if ((entity.getCapability(WardenCurseModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new WardenCurseModVariables.PlayerVariables())).Cancel_Prosthetic_Toggle == true) {
					if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == WardenCurseModItems.LOADED_AXE.get()) {
						if (entity instanceof LivingEntity _entity) {
					...
					entity.getPersistentData().putDouble("M_Axe_Slam_Timer", 0);
				}
			}
		} else {
			entity.getPersistentData().putDouble("M_Axe_Slam_Timer", (-1));
		}
	}
}
