...
public class FloatingSet5Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		{
			ItemStack _setval = new ItemStack(WardenCurseModItems.FLOATING_PASSAGE.get());
		...
		if (entity instanceof Player _player) {
			ItemStack _stktoremove = new ItemStack(WardenCurseModItems.FLOATING_PASSAGE.get());
