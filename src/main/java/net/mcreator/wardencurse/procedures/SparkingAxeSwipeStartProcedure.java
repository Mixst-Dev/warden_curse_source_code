...
public class SparkingAxeSwipeStartProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (entity.getPersistentData().getBoolean("S_Axe_SWIPE") == true) {
			entity.getPersistentData().putDouble("S_Axe_SWIPE_timer", (entity.getPersistentData().getDouble("S_Axe_SWIPE_timer") + 1));
			if (entity.getPersistentData().getDouble("S_Axe_SWIPE_timer") == 1) {
				{
				...
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(WardenCurseModMobEffects.NO_JUMP_2.get(), 53, 1));
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
			...
			if (entity.getPersistentData().getDouble("S_Axe_SWIPE_timer") == 5) {
			...
			if (entity.getPersistentData().getDouble("S_Axe_SWIPE_timer") == 18) {
				if ((entity.getCapability(WardenCurseModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new WardenCurseModVariables.PlayerVariables())).Cancel_Prosthetic_Toggle == true) {
			...
			if (entity.getPersistentData().getDouble("S_Axe_SWIPE_timer") == 36) {
				if ((entity.getCapability(WardenCurseModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new WardenCurseModVariables.PlayerVariables())).Cancel_Prosthetic_Toggle == true) {
			...
			if (entity.getPersistentData().getDouble("S_Axe_SWIPE_timer") >= 50) {
				if ((entity.getCapability(WardenCurseModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new WardenCurseModVariables.PlayerVariables())).Cancel_Prosthetic_Toggle == true) {
					...
					entity.getPersistentData().putDouble("S_Axe_SWIPE_timer", 0);
				}
			}
		} else {
			entity.getPersistentData().putDouble("S_Axe_SWIPE_timer", (-1));
		}
	}
}
