...
public class ItemtagstoppropertiesProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, DamageSource damagesource, Entity entity) {
		if (damagesource == null || entity == null)
			return;
		if (entity.getPersistentData().getBoolean("item_tag_stop") == true && (!damagesource.is(DamageTypes.ON_FIRE) || !damagesource.is(DamageTypes.STARVE) || !damagesource.is(DamageTypes.WITHER))) {
			entity.getPersistentData().putBoolean("item_tag_stop", false);
			if (entity instanceof Player _player && !_player.level().isClientSide())
				_player.displayClientMessage(Component.literal("Item useage cancelled!"), false);
