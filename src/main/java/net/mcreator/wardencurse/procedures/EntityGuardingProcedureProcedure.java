...
public class EntityGuardingProcedureProcedure {
	public static void execute(LevelAccessor world, Entity entity, double amount) {
		...
		entity.getPersistentData().putDouble("entity_posture", (entity.getPersistentData().getDouble("entity_posture") + amount * 2.5 * gokan));
