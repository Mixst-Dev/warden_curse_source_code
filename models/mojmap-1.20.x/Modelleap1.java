...
public class Modelleap1<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "leap1"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).mirror()
						.addBox(2.0F, -24.75F, -7.0F, 0.0F, 29.0F, 14.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-8.0F, -1.0F, 0.0F, 0.0F, 0.0F, -0.5236F));

		PartDefinition cube_r2 = bone
				.addOrReplaceChild("cube_r2",
						CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -24.75F, -7.0F, 0.0F, 29.0F, 14.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(8.0F, -1.0F, 0.0F, 0.0F, 0.0F, 0.5236F));

		PartDefinition cube_r3 = bone.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(28, 0).addBox(-7.0F, -26.0F, 2.0F, 14.0F, 26.0F, 0.0F,
						new CubeDeformation(0.0F)),
