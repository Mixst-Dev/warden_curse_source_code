...
public class Modelemmacross2<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "emmacross2"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = slash1
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(0, 58).addBox(-39.0F, -1.0F, -45.0F, 78.0F, 0.0F, 47.0F,
		...
		PartDefinition cube_r2 = slash1.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 58)
						.addBox(-39.0F, -1.5F, -45.0F, 78.0F, 0.0F, 47.0F, new CubeDeformation(0.0F)).texOffs(0, 58)
						.addBox(-39.0F, -1.0F, -45.0F, 78.0F, 0.0F, 47.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = slash2.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-42.0F, 3.5F, -56.0F, 69.0F, 0.0F, 58.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-42.0F, 3.0F, -56.0F, 69.0F, 0.0F, 58.0F, new CubeDeformation(0.0F)),
