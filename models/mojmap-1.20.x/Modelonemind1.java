...
public class Modelonemind1<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "onemind1"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition trail1 = partdefinition.addOrReplaceChild("trail1", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 9.0F, 0.0F, -0.1745F, 0.0F, -0.48F));
		...
		PartDefinition trail1_r2 = trail1.addOrReplaceChild("trail1_r2",
